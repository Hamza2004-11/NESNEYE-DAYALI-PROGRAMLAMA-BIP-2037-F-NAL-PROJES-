...
public class Main {
    ...
    public static void ornekVeriEkle(BiletSistemi biletSistemi) {
        var film1 = new Film("Interstellar", "Bilim Kurgu", 169, "Christopher Nolan");
        var film2 = new Film("Inception", "Bilim Kurgu", 148, "Christopher Nolan");
        var film3 = new Film("The Dark Knight", "Aksiyon", 152, "Christopher Nolan");

        biletSistemi.filmListesineEkle(film1);
        biletSistemi.filmListesineEkle(film2);
        biletSistemi.filmListesineEkle(film3);

        var musteri1 = new Musteri("Ali", "Aktif", "f@g.com", "1234567890");
        var musteri2 = new Musteri("Veli", "Pasif", "abc@g.com", "0987654321");
